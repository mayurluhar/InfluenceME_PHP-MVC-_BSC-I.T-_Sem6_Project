                           ...
                           <div class="profile-header">
                              ...
                              <div class="user-detail text-center mb-3">
                                 <div class="profile-img">
                                    <img src="<?php  echo base_url('resources/shared/images/'.$userinfo->profilepic) ?>" alt="profile-img" class="avatar-130 img-fluid" />
                                 </div>
                                 <div class="profile-detail">
                                    <h3 class=""><?php echo $userinfo->username  ?></h3>
                                 </div>
                              </div>
                                 ...
                                 <div class="social-links">
                                    <ul class="social-data-block d-flex align-items-center justify-content-between list-inline p-0 m-0">
                                       <li class="text-center pr-3">
                                          <a href="#"><img src="<?php  echo base_url('resources/user/') ?>images/icon/08.png" class="img-fluid rounded" alt="facebook"></a>
                                       </li>
                                       <li class="text-center pr-3">
                                          <a href="#"><img src="<?php  echo base_url('resources/user/') ?>images/icon/09.png" class="img-fluid rounded" alt="Twitter"></a>
                                       </li>
                                       <li class="text-center pr-3">
                                          <a href="#"><img src="<?php  echo base_url('resources/user/') ?>images/icon/10.png" class="img-fluid rounded" alt="Instagram"></a>
                                       </li>
                                       <li class="text-center pr-3">
                                          <a href="#"><img src="<?php  echo base_url('resources/user/') ?>images/icon/11.png" class="img-fluid rounded" alt="Google plus"></a>
                                       </li>
                                       <li class="text-center pr-3">
                                          <a href="#"><img src="<?php  echo base_url('resources/user/') ?>images/icon/12.png" class="img-fluid rounded" alt="You tube"></a>
                                       </li>
                                       ...
                                       <li>
                                         ...
                                         <span class="pull-right">
                                            <?php
                                                if ($asaveStatus=="no") {
                                                 ?>
                                                   <a href="<?php echo site_url("userC/profilesave/$userinfo->userID") ?>">
                                                 ...
                                                 <i class="ri-bookmark-line" ></i>
                                                  ...
                                                  <?php
                                                   ...
                                                   {
                                                   ?>
                                               <a href="<?php echo site_url("userC/profileunsave/$userinfo->userID") ?>">
                                       ...
                                       <li class="text-center pl-3">
                                         ...
                                         <span class="pull-right">
                                            <?php
                                                if ($fsaveStatus=="no") {
                                                 ?>
                                                   <a href="<?php echo site_url("userC/profileFollow/$userinfo->userID") ?>">
                                       
                                                 <i class="btn btn-outline-primary mb-3" >Follow</i>
                                                   </a>
                                                  <?php
                                                   }
                                                  else
                                                   {
                                                   ?>
                                               <a href="<?php echo site_url("userC/profileUnfollow/$userinfo->userID") ?>">
                                            
                                                <i class="btn btn-outline-primary mb-3"   style="color: skyblue;">Unfollow</i>
                                                </a>
                                                <?php
                                                  }
