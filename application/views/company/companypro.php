                           ...
                           <div class="profile-header">
                              ...
                              <div class="user-detail text-center mb-3">
                                 <div class="profile-img">
                                    <img src="<?php  echo base_url('resources/shared/images/'.$_SESSION['propic']) ?>" alt="profile-img" class="avatar-130 img-fluid" />
                                 </div>
                           ...
                           <div class="iq-card-body p-0">
                              <div class="row">
                                 ...
                                 <div class="col-lg-8">
                                    ...
                                    <div class="iq-card-header d-flex justify-content-between">
                                   <div class="iq-header-title">
                                 <h4 class="card-title">Create Requirement</h4>
                              </div>
                           </div>
                              ...
                              <div class="modal-dialog" role="document">
                                 <div class="modal-content">
                                    <div class="modal-header">
                                       <h5 class="modal-title" id="post-modalLabel">Create Requirement</h5>
                                    ...
                                    <div class="modal-body">
                                       <div class="d-flex align-items-center">
                                          ...
                                          <!-- POST DATA -->
                                          <form method="post" enctype="multipart/form-data" class="post-text ml-3 w-100" action="<?php  echo site_url('company/requirementC/registerRequirement') ?>">
                                       ...
                                       <ul class="d-flex flex-wrap align-items-center list-inline m-0 p-0">
                                          <div class="iq-card-body">
                                             ...
                                             <form class="email-form">
                                                ...
                                                <div class="form-group row">
                                                   <label for="cc" class="col-sm-2 col-form-label">Description:</label>
                                                   <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="txtDescription" >
                                                   </div>
                                                </div>
                                                <div class="form-group row">
                                                   <label for="subject" class="col-sm-2 col-form-label">budget:</label>
                                                   <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="txtBudget" >
                                                   </div>
                                                </div>
                              ...
                              <div class="user-post-data">
                                 <div class="d-flex flex-wrap">
                                    ...
                                    <div class="media-support-info mt-2">
                                       <h5 class="mb-0 d-inline-block"><a href="#" class=""><?php echo $r->com_name ?></a></h5>
                                       ...
                                       <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu m-0 p-0">
                                             <a class="dropdown-item p-3" href="<?php
                                               echo site_url("company/companyC/editRequirement/".$r->requirID)?>">
