...
<head>
                ...
                <div class="row no-gutters" >
                    ...
                    <div class="offset-lg-6 col-lg-6 bg-white pt-5" >
                        <div class="sign-in-from" >
                            ...
                            <form method="post" enctype="multipart/form-data" class="mt-4" action="<?php  echo site_url('company/companyC/registerUser') ?>" >
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="number" class="form-control mb-0"  placeholder="Enter email" name="txtMobileno" />
                                </div>
                                ...
                                <div class="form-group ">
                                    <label for="exampleInputEmail2">Descripsion</label>
                                    <input type="text" class="form-control mb-0"  placeholder="Enter email" name="txtDes" />
                                </div>
 ...
 -->
                                ...
                                <div class="sign-info">
                                    <span class="dark-color d-inline-block line-height-2">Already Have Account ? <a href="<?php  echo site_url('company/companyC/index') ?>">Log In</a></span>
      ...
      function loadCity(sid){
          ...
          {
            $.ajax({
              url:"<?php echo site_url('company/companyC/loadCityByStateId/') ?>"+sid,
