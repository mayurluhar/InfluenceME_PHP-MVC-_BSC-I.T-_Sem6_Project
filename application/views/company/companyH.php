                                 ...
                                 <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                       <div class="d-flex align-items-center">
                                          ...
                                          <!-- POST DATA -->
                                             <form method="post" enctype="multipart/form-data" class="post-text ml-3 w-100" action="<?php  echo site_url('company/companyC/registerPost') ?>">
                                     ...
                                     <hr>
                                       ...
                                       <ul class="d-flex flex-wrap align-items-center list-inline m-0 p-0">
                                          ...
                                          <div class="form-group col-sm-10">
                                             <label>Budget</label>
                                             <input type="number" class="form-control" name="txtBud" >
                                          </div>
                                       </div>
                                          </li>
                    ...
                    <div class="col-sm-12">
                        <div class="iq-card">
                           ...
                           <div class="iq-card-body">
                                 ...
                                 <div class="d-flex flex-wrap">
                                   <!--  <div class="media-support-user-img mr-3">
                                    ...
                                    <div class="media-support-info mt-2">
                                       <h5 class="mb-0 d-inline-block"><a href="<?php echo site_url('company/companyC/profileOU/'.$p->companyID) ?>" class=""><?php echo $p->com_name ?></a></h5>
                                       <p class="mb-0 text-primary"><?php echo $p->requir_date  ?></p>
                                    </div>
                              ...
                              <div class="mt-3">
                                 <p class="h2 mb-3 text-center"><?php echo $p->title  ?></p>
                              </div>
                              <div class="mt-3">
                                 <p><?php echo $p->description  ?></p>
                              </div>
                              <div class="mt-3">
                                 <p><?php echo $p->budget  ?></p>
                              </div>
                              <!--  <div class="user-post">
