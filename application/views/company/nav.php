            ...
            <div id="sidebar-scrollbar">
               <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                     ...
                     <li>
                        <a href="<?php echo site_url("company/companyC/applicationData");  ?>" class="iq-waves-effect"><i class="las la-newspaper"></i><span>Application</span></a>
                     </li>
                     <li>
                        <a href="<?php echo site_url("company/companyC/displayAllNotification");  ?>" class="iq-waves-effect"><i class="las la-newspaper"></i><span>Notification</span></a>
                     </li>
                     <li>
                        <a href="<?php echo site_url("company/companyC/insertuserReview");  ?>" class="iq-waves-effect"><i class="las la-newspaper"></i><span>Review</span></a>
                     </li>
