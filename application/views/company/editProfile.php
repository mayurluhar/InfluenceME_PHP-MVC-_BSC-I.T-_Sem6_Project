                        ...
                        <div class="tab-content">
                           <div class="tab-pane fade active show" id="personal-information" role="tabpanel">
                              <div class="iq-card">
                                 ...
                                 <div class="iq-card-body">
                                    <form method="post" enctype="multipart/form-data" action="<?php echo site_url("company/editProfileC/editBasic") ?>">

                                        <div class=" row align-items-center">
                                          <div class="form-group col-sm-6">
                                             <label>Company name</label>
                                             <input type="text" class="form-control" name="txtCname" value="<?php echo $userinfo->com_name ?>">
                                          </div>
                                       ...
                                       <div class=" row align-items-center">
                                          ...
                                          <div class="form-group col-sm-6">
                                             ...
                                             <input type="Number" class="form-control" name="txtContactno" value="<?php echo $userinfo->contactno ?>">
                                          </div>
                           ...
                           <div class="tab-pane fade" id="chang-pwd" role="tabpanel">
                              <div class="iq-card">
                                 ...
                                 <div class="iq-card-body">
                                    <form method="post" action="<?php echo site_url("company/editProfileC/editPassword") ?>" >
                           ...
                           <div class="tab-pane fade" id="manage-contact" role="tabpanel">
                              <div class="iq-card">
                                 ...
                                 <div class="iq-card-body">
                                    <form method="post" enctype="multipart/form-data" action="<?php echo site_url("company/editProfileC/editImage") ?>">
                                       <div class="form-group row align-items-center">
                                          <div class="col-md-12">
                                             <div class="profile-img-edit">
                                                <img class="profile-pic" src="<?php  echo base_url('resources/shared/images/'.$_SESSION['propic']) ?>" alt="New Profile-Pic">
                                                <div class="p-image">
