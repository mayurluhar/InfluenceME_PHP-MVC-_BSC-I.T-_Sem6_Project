            ...
            <div class="iq-navbar-custom">
               <nav class="navbar navbar-expand-lg navbar-light p-0">
                  <div class="iq-navbar-logo d-flex justify-content-between">
                     <a href="<?php  echo site_url('userC/userHome') ?>">
                  ...
                  <div class="iq-search-bar">
                     <form action="<?php echo site_url('userC/search') ?>" method="post" class="searchbox">
                        <input type="text" class="text search-input" placeholder="Type here to search..." name="txtsearch">
                        <!--<a class="search-link" href="#"><i class="ri-search-line"></i></a>-->
                  </div>
                  <div>
                     <button type="submit" class="btn btn-primary d-block w-100 mt-2" name="btnSearch" value="Search">Search</button>
                     </form>
                  </div>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     <ul class="navbar-nav ml-auto navbar-list">
                        <li>
                           <a href="<?php  echo site_url('userC/profileP/'.$_SESSION['uid']) ?>" class="iq-waves-effect d-flex align-items-center">
                           ...
                           <div class="iq-sub-dropdown iq-user-dropdown">
                              <div class="iq-card shadow-none m-0">
                                 <div class="iq-card-body p-0 ">
                                    ...
                                    <a href="<?php echo site_url("editProfileC/editProfile"); ?>" class="iq-sub-card iq-bg-warning-hover">
                                       <div class="media align-items-center">
                                    ...
                                    <a href="<?php echo site_url("userC/pLink")  ?>" class="iq-sub-card iq-bg-info-hover">
                                       <div class="media align-items-center">
                                    ...
                                    <div class="d-inline-block w-100 text-center p-3">
                                       <a class="bg-primary iq-sign-btn" href="<?php  echo site_url('userC/logout') ?>" role="button">Sign out<i class="ri-login-box-line ml-2"></i></a>
                                    </div>
                                 </div>
                              </div>
                           </div>
