          ...
          <div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <a href="<?php  echo site_url("admin/Category/loadAddstate") ?>" class="btn btn-primary">Add State</a>
                ...
                <tbody class="table-info">
                  <tr>
                    ...
                    foreach ($states as $s) {
                      ...
                      <td><a href="<?php echo site_url("admin/Category/removeState/".$s->stateID) ?>">DELETE</a></td>
                      <td><a href="<?php echo site_url("admin/Category/loadAllSubCity/".$s->stateID) ?>">Load All Cats</a></td>
